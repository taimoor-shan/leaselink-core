...
$icons = [
    ...
    'message' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />',
...
<div class="p-10 text-center">
    <svg class="w-12 h-12 text-zinc-300 mx-auto mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <?php echo $svg_path; ?>
    </svg>
    <h3 class="text-base font-semibold text-dark mb-1"><?php echo esc_html($title); ?></h3>
    <?php if ($description): ?>
        <p class="text-sm text-gray mb-4"><?php echo esc_html($description); ?></p>
    <?php endif; ?>
    <?php if ($action_url && $action_text): ?>
        <a href="<?php echo esc_url($action_url); ?>" class="ll-btn ll-btn-primary no-underline">
